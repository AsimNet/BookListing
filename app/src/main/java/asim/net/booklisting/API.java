...
public final class API {
    ...
    private static List<Book> extractBookFromJson(String bookJSON) {
        ...
        Log.i("API", "extractBookFromJson: "+bookJSON);
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                // key called "volumeInfo", which represents a list of all book's info
                ...
                // Extract the value for the key called "authors" and get the first author.
                String author = "UNKNOWN";

                if (!volumeInfo.isNull("authors")) {
                    JSONArray authors = volumeInfo.getJSONArray("authors");
                    Log.i("API", "authors: " + authors);
                    Log.i("API", "extractBookFromJson: " + authors.toString());
                    author = (String) authors.get(0);
                    Log.i("API", "author: " + author);
                }
                String bookURL = accessInfo.getString("webReaderLink");
                // Create a new {@link book} object with the title, author.
                // from the JSON response.
                Book book = new Book(title, author, bookURL);
            ...
            Log.e("API", "Problem parsing the book JSON results", e);
        }
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e("API", "Problem retrieving the book JSON results.", e);
        } finally {
